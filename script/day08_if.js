...
/* const walkAmount = Number(window.prompt('하루걸음수는?'))
if(walkAmount >= 10000){
    window.alert('목표달성')
} */
// ----------------------------------------------------------
// 거짓일 때 조건문
// if(조건식){조건식이 참일때 실행문}else{거짓일 때 실행문}
...
// 홀수 -> '홀수입니다'
/* const num = Number(window.prompt('1~99까지 숫자를 입력하세요'))
if(num%2===0){window.alert('짝수입니다')}else{window.alert('홀수입니다')} */
// 중첩 if문 (if문 안 if문 삽입)
...
//    if(pw === 'a1234')/* 2단 if(1단 if가 참일 경우 읽는 조건) */
    ...
    //}
    // 중첩 if문 종료
//}else{window.alert('로그인 실패, 아이디 오류')}
//---------------------------------------------
// 논리연산자 &&(and) ||(or)
let a = 10
...
if(score >= 90 && score < 101){console.log('A')}else{console.log('F')}
