// 반복문 for
/* 
    for(반복문변수생성; 변수활용조건식; 변수증감식){반복문 변수 조건이 참일 때 반복실행문}반복문 변수 조건이 거짓일때 for 끝나는 위치
*/
// 1~10까지 반복하는 반복문
...
// 0~5 반복문
for(let i=0; i<6; i++){console.log('hi'+i)}
// 5~0 반복문
for(let i=5; i>=0; i--){console.log('hi'+i)}
// 10~30 반복문 + 10~30 중 홀수만 반복출력
for(let i=10; i<31; i++){if(i%2===1){console.log(i)}}
// 10~30 반복문 + 10~30 중 짝수만 반복출력
for(let i=10; i<31; i++){if(i%2===0){console.log(i)}}
// DOM, 배열 사용하는 반복문
...
for(let i=0; i<coffee.length; i++){console.log(coffee[i])}
