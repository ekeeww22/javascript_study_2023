...
color.innerHTML = colorArray[2]+' , '+colorArray[3];
weather.innerHTML = weatherArray[0]+' , '+weatherArray[2];
...
optionArray[0] = 'white'
optionArray[2] = 'M'
console.log(optionArray) // "white" empty "M" empty
